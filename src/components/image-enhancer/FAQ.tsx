...
function FAQ() {
    ...
    const faqData = [
        { q: t('enhancer.faq.q1'), a: t('enhancer.faq.a1') },
        { q: t('enhancer.faq.q2'), a: t('enhancer.faq.a2') },
        { q: t('enhancer.faq.q3'), a: t('enhancer.faq.a3') },
        { q: t('enhancer.faq.q4'), a: t('enhancer.faq.a4') },
        { q: t('enhancer.faq.q5'), a: t('enhancer.faq.a5') },
        { q: t('enhancer.faq.q6'), a: t('enhancer.faq.a6') },
    ]
