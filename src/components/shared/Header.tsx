...
export default function Header() {
    ...
    useEffect(() => {
        ...
        document.documentElement.dir = languages[language as Language].dir as 'ltr' | 'rtl';
        if (languages[language as Language].dir === 'rtl') {
                        ...
                        <div className="relative" ref={toolsRef}>
                            ...
                            {toolsOpen && (
                                <div className="absolute top-full left-0 mt-2 w-80 bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 p-5 max-h-96 overflow-y-auto">
                                    <a
                                        href={`/${language}`}
                                        className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 hover:scale-110 mb-2"
                                    >
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2">
                                                <span className="font-semibold text-gray-900 dark:text-white">Remove Background</span>
                                            </div>
                                            <p className="text-sm text-gray-600 dark:text-gray-400">Remove backgrounds with AI</p>
                                        </div>
                                    </a>
                                    <a
                                        href={`/${language}/image-enhancer`}
                                        className="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 hover:scale-110 mb-2"
                                    >
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2">
                                                <span className="font-semibold text-gray-900 dark:text-white">Image Enhancer</span>
                                            </div>
                                            <p className="text-sm text-gray-600 dark:text-gray-400">Enhance image quality instantly</p>
                                        </div>
                                    </a>
                                    <a
                                        href="#"
                                        className="flex items-start gap-3 p-3 rounded-lg opacity-50 cursor-not-allowed mb-2"
                                    >
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2">
                                                <span className="font-semibold text-gray-900 dark:text-white">Object Remover</span>
                                                <span className="text-xs text-red-500 ml-4">(releasing soon)</span>
                                            </div>
                                            <p className="text-sm text-gray-600 dark:text-gray-400">Remove unwanted objects</p>
                                        </div>
                                    </a>
                                    <a
                                        href="#"
                                    ...
                                    >
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2">
                                                <span className="font-semibold text-gray-900 dark:text-white">Magic Eraser</span>
                                                <span className="text-xs text-red-500 ml-4">(releasing soon)</span>
                                            </div>
                                            <p className="text-sm text-gray-600 dark:text-gray-400">Erase with smart AI</p>
                                        </div>
                                    </a>
                                    <a
                                        href="#"
                                    ...
                                    >
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2">
                                                <span className="font-semibold text-gray-900 dark:text-white">Background Generator</span>
                                                <span className="text-xs text-red-500 ml-4">(releasing soon)</span>
                                            </div>
                                            <p className="text-sm text-gray-600 dark:text-gray-400">Generate AI backgrounds</p>
                                        </div>
                                    </a>
                                    <a
                                        href="#"
                                    ...
                                    >
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2">
                                                <span className="font-semibold text-gray-900 dark:text-white">Replace Background</span>
                                                <span className="text-xs text-red-500 ml-4">(releasing soon)</span>
                                            </div>
                                            <p className="text-sm text-gray-600 dark:text-gray-400">Replace with custom backgrounds</p>
                                        </div>
                                    </a>
                                    <a
                                        href="#"
                                    ...
                                    >
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2">
                                                <span className="font-semibold text-gray-900 dark:text-white">Photo Colorizer</span>
                                                <span className="text-xs text-red-500 ml-4">(releasing soon)</span>
                                            </div>
                                            <p className="text-sm text-gray-600 dark:text-gray-400">Colorize black & white photos</p>
                                        </div>
                                    </a>
                                </div>
                            )}
